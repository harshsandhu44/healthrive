    ...
    <main className="space-y-6">
      <div className="flex flex-col gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Patient ID: {patient.id} • Medical History & Records
          </p>
        </div>
      </div>
      ...
      <ScrollArea className="h-full">
        <Tabs defaultValue="overview" className="w-full">
          <TabsList className="h-auto flex flex-wrap items-start justify-start gap-2">
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  <div>
                    ...
                    {patient.socialHistory.smokingStatus}
                  </div>
                  <div>
                    <strong>Alcohol:</strong>{" "}
                    {patient.socialHistory.alcoholConsumption}
                  </div>
                </CardContent>
              </Card>
            </div>
                ...
                {patient.labResults.map((lab, index) => (
                  <div key={index} className="border rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-3 gap-4 text-sm">
                      ...
                      <div>
                        <strong>Units:</strong> {lab.units}
                      </div>
                      <div>
                        <strong>Reference:</strong> {lab.referenceRange}
                      </div>
                    </div>
                  </div>
                ))}
