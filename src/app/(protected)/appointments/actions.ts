...
export async function updateAppointment(
  ...
  try {
    ...
    if (appointmentData.patientName)
      updateData.patient_name = appointmentData.patientName;
    if (appointmentData.doctor) updateData.doctor = appointmentData.doctor;
    ...
    if (appointmentData.notes) {
      updateData.notes = `${appointmentData.notes || ""}`.trim() || null;
    }
